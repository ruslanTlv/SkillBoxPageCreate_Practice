...
class ViewController: UIViewController {
    ...
    var array: [Info] = [Info(header: "Mike", description: "He will want to use your yacht, and I dont't want this thing smelling like fish", time: "8m ago", image: UIImage(named: "pic1")!, isLiked: false),
                         Info(header: "James", description: "He will want to use your yacht, and I dont't want this thing smelling like fish", time: "8m ago", image: UIImage(named: "pic2")!, isLiked: false),
                         Info(header: "Viktor", description: "He will want to use your yacht, and I dont't want this thing smelling like fish", time: "8m ago", image: UIImage(named: "pic5")!, isLiked: false),
                         Info(header: "Alan", description: "He will want to use your yacht, and I dont't want this thing smelling like fish", time: "8m ago", image: UIImage(named: "pic6")!, isLiked: false),
                         Info(header: "Marina", description: "He will want to use your yacht, and I dont't want this thing smelling like fish", time: "8m ago", image: UIImage(named: "pic3")!, isLiked: false),
                         Info(header: "Brook", description: "He will want to use your yacht, and I dont't want this thing smelling like fish", time: "8m ago", image: UIImage(named: "pic4")!, isLiked: false)]
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.name = array[indexPath.row].header
        vc.image = array[indexPath.row].image
